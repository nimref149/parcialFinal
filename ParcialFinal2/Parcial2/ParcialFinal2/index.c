...
int esSoloLetrasYpuntos(char str[])
{
    int i=0;
    while(str[i] != '\0')
    {
...
int getStringLetrasYpuntos(char* input,char message[],char eMessage[], int lowLimit, int hiLimit){
    ...
    fflush(stdin);
    esValido=esSoloLetrasYpuntos(auxString);
    if(esValido==0)
    {
